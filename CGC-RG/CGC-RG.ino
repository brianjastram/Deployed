...
const char *sketchName = "CGC.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "CGC-Mayfly";
...
Variable *variableList[] = {
    ...
    new RainCounterI2C_Depth(&tbi2c, "c5a40208-fbaa-4499-9a2b-9cee0c28a8f6"),
    new ProcessorStats_Battery(&mcuBoard, "901c64a9-0dda-4dd1-b6b9-1eb794b7e356"),
    new MaximDS3231_Temp(&ds3231, "b348be3a-305b-484e-9a2f-24ffedd120d3"),
    new Modem_RSSI(&modem, "327d0c79-223a-4390-affe-13120cee4a0f"),
    new Modem_SignalPercent(&modem, "3631b00b-fbd9-46c9-8a69-1061ca87a8ae"),
};
...
const char *registrationToken = "8c35c56d-f5c1-4d0e-8151-cbc18c29cd58";   // Device registration token
const char *samplingFeature = "a7f58694-9139-4782-af37-9e9d026e36c0";     // Sampling feature UUID
