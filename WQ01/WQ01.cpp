...
{
    "06286e04-35b2-4f68-bc88-f97de497cf23",   // Water depth (Meter_Hydros21_Depth)
    "1e2bc1b3-9270-4979-bc8e-65ea6a4f8ed5",   // Temperature (Meter_Hydros21_Temp)
    "9ecea3c0-c4af-4afa-969e-e376bb9b1ef4",   // Specific Conductance (Meter_Hydros21_Cond)
    "62d856f6-ce11-4c93-afc2-1566c090d127",   // Temperature (Maxim_DS3231_Temp)
    "cc34d8ac-57a8-4fe7-93c8-d18facfc0c87",   // Moden_RSSI (EnviroDIY_LTEB_RSSI)
    "61fdb06f-8aa6-4087-a780-1b2e8e098b29",   // Modem_Signal Percent (EnviroDIY_LTEB_SignalPercent)
    "2c53e33a-8e64-4706-a564-0229e6409e07"    // Battery voltage (EnviroDIY_Mayfly_Batt)
};
const char *registrationToken = "bdee359d-cf65-42d8-99f8-b611208a332c";   // Device registration token
const char *samplingFeature = "9a52a43b-bde7-48ef-87ba-dae090493ac0";     // Sampling feature UUID
