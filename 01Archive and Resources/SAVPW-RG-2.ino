...
Adapted by Anthony and Brian - BJ - 9/26/19
...
const char *sketchName = "SAVPW-RG-2.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "SAVPW-RG-2-Mayfly";
...
Variable *variableList[] = {
    ...
    new RainCounterI2C_Depth(&tbi2c, "e81644e9-9134-4629-9da3-28fa855c91c2"),
    new ProcessorStats_Battery(&mcuBoard, "cc96b65d-f1cb-48d1-bae6-836ce28ceb19"),
    new MaximDS3231_Temp(&ds3231, "aa875fe8-73e0-4348-995d-7c6ac55b5722"),
    new Modem_RSSI(&modem, "ef5dc79c-3870-4a7d-8890-1b1ca7e40446"),
    new Modem_SignalPercent(&modem, "6d27fc33-d6ff-454f-ae61-02e5c2ea3fa0"),
};
...
const char *registrationToken = "ad282a42-09c8-4f8b-a1e4-31bc7ce0cac1";   // Device registration token
const char *samplingFeature = "fd17b52b-99f5-4f4a-8a47-d23984075462";     // Sampling feature UUID
