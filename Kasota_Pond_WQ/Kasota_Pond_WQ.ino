...
const char *LoggerID = "Kasota_Pond_WQ";
...
Variable *ctdCond = new DecagonCTD_Cond(&ctd, "afacb737-a036-4f65-8ca2-a8422c8e0e4f");
Variable *ctdTemp = new DecagonCTD_Temp(&ctd, "5851f6f7-edb0-4bd0-9149-af545632cb1f");
Variable *ctdDepth = new DecagonCTD_Depth(&ctd, "9e5ecec3-d163-4e01-92d0-02f38f367fdd");
...
//    new ProcessorStats_SampleNumber(&mcuBoard, "12345678-abcd-1234-ef00-1234567890ab"),
    new ProcessorStats_Battery(&mcuBoard, "1ee1ec22-9d52-47bf-bdf4-9381d5f313e0"),
    new MaximDS3231_Temp(&ds3231, "67c54799-8b47-4f9f-aa77-34afee14bbf7"),
    new Modem_RSSI(&modem, "1cff99c3-a1ac-4b7f-9743-d535c4e62be8"),
    new Modem_SignalPercent(&modem, "dcc7146d-124e-4964-a43e-dcc2ece7ab88"),
    new DecagonCTD_Cond(&ctd, "afacb737-a036-4f65-8ca2-a8422c8e0e4f"),
    new DecagonCTD_Temp(&ctd, "5851f6f7-edb0-4bd0-9149-af545632cb1f"),
    new DecagonCTD_Depth(&ctd, "9e5ecec3-d163-4e01-92d0-02f38f367fdd"),
};
...
const char *registrationToken = "761b1c25-6efe-496d-a241-d25961a45218";   // Device registration token
const char *samplingFeature = "1aefa4ca-ff9f-4ac4-9e18-ef496525f8dc";     // Sampling feature UUID
