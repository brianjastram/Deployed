...
const char *LoggerID = "7LSTU_Riv_WQ";
...
Variable *ctdCond = new DecagonCTD_Cond(&ctd, "8c2e3030-09c8-4bd3-8c1d-e17d1e7abb4d");
Variable *ctdTemp = new DecagonCTD_Temp(&ctd, "3da23e75-30d9-442d-8ba6-f5b0b58ba5c8");
Variable *ctdDepth = new DecagonCTD_Depth(&ctd, "4432003d-4765-49d7-b36f-49829a6c058f");
...
//    new ProcessorStats_SampleNumber(&mcuBoard, "12345678-abcd-1234-ef00-1234567890ab"),
    new ProcessorStats_Battery(&mcuBoard, "cec8347f-da29-4499-a761-92336eb8dacb"),
    new MaximDS3231_Temp(&ds3231, "31b37259-1c30-4de0-be11-5cd01c0708a7"),
    new Modem_RSSI(&modem, "66ac8fe3-731f-4066-8ee2-d0a9e859bf64"),
    new Modem_SignalPercent(&modem, "25135371-3d3c-4a7f-b413-3b272f83a15c"),
    new DecagonCTD_Cond(&ctd, "8c2e3030-09c8-4bd3-8c1d-e17d1e7abb4d"),
    new DecagonCTD_Temp(&ctd, "3da23e75-30d9-442d-8ba6-f5b0b58ba5c8"),
    new DecagonCTD_Depth(&ctd, "4432003d-4765-49d7-b36f-49829a6c058f"),
};
...
const char *registrationToken = "83974672-8bb9-45ee-8b45-8cf641de0a6b";   // Device registration token
const char *samplingFeature = "5009e787-4b8b-4809-833c-5c67a027de77";     // Sampling feature UUID
