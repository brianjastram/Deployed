...
const char *sketchName = "WP-RG.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "WP-Mayfly";
...
Variable *variableList[] = {
    ...
    new RainCounterI2C_Depth(&tbi2c, "fc8a60b6-6abb-458c-b092-bb47a55300d3"),
    new ProcessorStats_Battery(&mcuBoard, "5cfa7126-0efe-4290-a4db-d8824e3ef884"),
    new MaximDS3231_Temp(&ds3231, "6eb95012-a49d-4c6e-b540-04ee8b8327dc"),
    new Modem_RSSI(&modem, "dbf70fbb-1a3b-4d7a-bba8-fe312003bb64"),
    new Modem_SignalPercent(&modem, "394a4fce-293e-44d7-b37f-cee0ba609edd"),
};
...
const char *registrationToken = "78e6f221-47a5-43a8-8626-7c8c0bae2308";   // Device registration token
const char *samplingFeature = "f8d50e1e-1c67-4ddd-ab02-60e240c042d5";     // Sampling feature UUID
