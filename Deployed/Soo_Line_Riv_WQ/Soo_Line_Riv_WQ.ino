...
const char *LoggerID = "Fridley_Pond_WQ";
...
Variable *ctdCond = new DecagonCTD_Cond(&ctd, "c67e24ef-dcd1-4fa2-999d-62049859b58f");
Variable *ctdTemp = new DecagonCTD_Temp(&ctd, "551a44b5-fb69-470e-83ff-9400e661599e");
Variable *ctdDepth = new DecagonCTD_Depth(&ctd, "cd34f8af-6e27-46ae-a14d-c56e79cfe041");
...
//    new ProcessorStats_SampleNumber(&mcuBoard, "12345678-abcd-1234-ef00-1234567890ab"),
    new ProcessorStats_Battery(&mcuBoard, "41f448d6-e915-4deb-a957-2ca0712ea423"),
    new MaximDS3231_Temp(&ds3231, "4aa4666f-8c90-4122-8dc1-21cad08ff8ab"),
    new Modem_RSSI(&modem, "9a9b2bd4-bcab-4874-a362-770cecdf6079"),
    new Modem_SignalPercent(&modem, "bb3f3f20-af41-462b-af84-54bb86a159eb"),
    new DecagonCTD_Cond(&ctd, "c67e24ef-dcd1-4fa2-999d-62049859b58f"),
    new DecagonCTD_Temp(&ctd, "551a44b5-fb69-470e-83ff-9400e661599e"),
    new DecagonCTD_Depth(&ctd, "cd34f8af-6e27-46ae-a14d-c56e79cfe041"),
};
...
const char *registrationToken = "a68bbca5-678f-46b3-8176-2cc5d414187f";   // Device registration token
const char *samplingFeature = "b4e64273-5fab-46b5-8fd1-a98aabd5a112";     // Sampling feature UUID
