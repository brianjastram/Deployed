...
const char *wifiId = "iPhone";  // The WiFi access point, unnecessary for gprs
const char *wifiPwd = "gandalfwizard";  // The password for connecting to WiFi, unnecessary for gprs
=======
const char *apn = "Hologram";  // The APN for the gprs connection, unnecessary for WiFi
...
const int8_t SDI12Data = 11;  // The SDI12 data pin
...
<<<<<<< HEAD
    new MaximDS18_Temp(&ds18, "d85b3c6c-2d7e-48ba-813c-4ac873538a83"),
    new ProcessorStats_Batt(&mcuBoard, "a0fa9be3-e88a-4157-b435-96bf72655b3e"),
    new MaximDS3231_Temp(&ds3231, "53f571ad-3613-40e0-a7d9-1905232019ee"),
    new Modem_RSSI(&modem, "12345678-abcd-1234-efgh-1234567890ab"),
    new Modem_SignalPercent(&modem, "12345678-abcd-1234-efgh-1234567890ab"),

=======
    new MaximDS18_Temp(&ds18, "cba2f422-feaa-4a4f-93ae-e61cb56a66c2"),
    new ProcessorStats_Batt(&mcuBoard, "317f1fa3-6e90-4cf6-8ba6-f0491aeeeff5"),
...
<<<<<<< HEAD
const char *registrationToken = "8af47943-9093-4994-a3cb-24961214c7de";   // Device registration token
const char *samplingFeature = "4309a8b8-13df-4f66-8c92-42b31e3285ab";     // Sampling feature UUID
=======
