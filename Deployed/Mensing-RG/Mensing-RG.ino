...
const char *sketchName = "Mensing-RG.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "Mensing-mayfly";
...
Variable *variableList[] = {
    ...
    new RainCounterI2C_Depth(&tbi2c, "ff8c49e1-bdfb-4c9c-9365-edf16287e7ca"),
    new ProcessorStats_Battery(&mcuBoard, "2436b5cc-0073-498e-9616-fb750fc6fd24"),
    new MaximDS3231_Temp(&ds3231, "a669d74f-01a5-4d34-8a9c-e85697f8fcff"),
    new Modem_RSSI(&modem, "61e1ffb8-2215-46b1-ad5f-7877a94fbe42"),
    new Modem_SignalPercent(&modem, "d4066dc5-91f2-48e8-872d-f31451e6f1af"),
};
...
const char *registrationToken = "dc090a47-e8e6-4efa-95be-1e0ca661a7c6";   // Device registration token
const char *samplingFeature = "34d0f58c-9bb6-4a5c-b0d3-befb58594564";     // Sampling feature UUID
