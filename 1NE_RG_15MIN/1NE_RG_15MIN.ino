...
const char *sketchName = "1NE_RG_15MIN.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "1NE-mayfly";
...
Variable *variableList[] = {
    ...
    new RainCounterI2C_Depth(&tbi2c, "ae3fc3dd-392f-445d-b6ae-32bfe58321b3"),
    new ProcessorStats_Battery(&mcuBoard, "ec7ea02a-de4c-4772-b030-8d5d16f477df"),
    new MaximDS3231_Temp(&ds3231, "61210065-ae03-4644-9c9f-50a1fe3d1cd7"),
    new Modem_RSSI(&modem, "27762d92-fc3d-43f2-9929-1a21988b20ef"),
    new Modem_SignalPercent(&modem, "9021c03a-1210-4e2e-9fbf-7f196e0b5d27"),
};
...
const char *registrationToken = "b7d869b3-9739-4d60-91e9-32a3744ebabf";   // Device registration token
const char *samplingFeature = "44a3f0f6-48b0-48f6-876c-6253ca3e2f64";     // Sampling feature UUID
